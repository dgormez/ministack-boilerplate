    ...
    <View className="flex-1 bg-white dark:bg-gray-900">
      <ScreenContainer>
        ...
        <View className="px-5 pt-16 pb-4 flex-row items-center justify-between">
          <Text className="text-gray-900 dark:text-white text-2xl font-bold">Notes</Text>
          <TouchableOpacity
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View className="items-center pt-24">
              <Text className="text-gray-400 dark:text-gray-500 text-lg">No notes yet</Text>
          ...
          renderItem={({ item }) => (
            <TouchableOpacity
              ...
              className="bg-gray-100 dark:bg-gray-800 rounded-xl px-4 py-4 mb-3 active:opacity-70"
            >
              <Text className="text-gray-900 dark:text-white font-semibold text-base" numberOfLines={1}>
                {item.title}
              </Text>
              {!!item.body && (
                <Text className="text-gray-500 dark:text-gray-400 text-sm mt-1" numberOfLines={2}>
                  {item.body}
                </Text>
              )}
